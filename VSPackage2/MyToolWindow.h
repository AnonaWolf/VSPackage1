...
class VSPackage2WindowPane :
	public CComObjectRootEx<CComSingleThreadModel>,
	public VsWindowPaneFromResource<VSPackage2WindowPane, IDD_VSPackage2_DLG>,
	public VsWindowFrameEventSink<VSPackage2WindowPane>,
...
{
	VSL_DECLARE_NOT_COPYABLE(VSPackage2WindowPane)

protected:

	// Protected constructor called by CComObject<VSPackage2WindowPane>::CreateInstance.
	VSPackage2WindowPane() :
...
BEGIN_COM_MAP(VSPackage2WindowPane)
...
BEGIN_MSG_MAP(VSPackage2WindowPane)
...
END_MSG_MAP()
	...
	{
		VsWindowFrameEventSink<VSPackage2WindowPane>::SetSite(GetVsSiteCache());
...
class VSPackage2ToolWindow :
	public VSL::ToolWindowBase<VSPackage2ToolWindow>
{
public:
	...
	VSPackage2ToolWindow(const PackageVsSiteCache& rPackageVsSiteCache):
	...
	IUnknown* GetViewObject()
	{
		...
		CComObject<VSPackage2WindowPane>* pViewObject;
		VSL_CHECKHRESULT(CComObject<VSPackage2WindowPane>::CreateInstance(&pViewObject));
