...
[$RootKey$\KeyBindingTables\{5bbb7e02-4582-41f8-87bf-85cedb4e0d46}]
@="#1"
...
VSPackage2UI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_VSPackage2Lib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_VSPackage2CmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_VSPackage2EditorDocument, LastMacro, eLastMacroNone> m_Recorder;
