...
/***************************************************************************
VSPackage2.pkgdef contains:


[$RootKey$\Editors\{46a47d27-bea2-4de5-b625-9d4729942a46}]
@="VSPackage2"
"Package"="{dda4de06-4153-4b1b-8f2d-479bf90084e6}"
"DisplayName"="VSPackage2"
"ExcludeDefTextEditor"=dword:00000001
"AcceptBinaryFiles"=dword:00000000

[$RootKey$\Editors\{46a47d27-bea2-4de5-b625-9d4729942a46}\LogicalViews]
"{7651A703-06E5-11D1-8EBD-00A0C90F26EA}"=""

[$RootKey$\Editors\{46a47d27-bea2-4de5-b625-9d4729942a46}\Extensions]
"vspackage2"=dword:00000032

which informs the shell that VSPackage2Package is the package to create to have this editor 
registered with Visual Studio.  When VSPackage2Package is sited by Visual Studio, 
VSPackage2Package::PostSited creates an instance of EditorFactory and then queries
...
#pragma warning(pop)
		...
		VSEDITORCREATEDOCWIN& /*rCreateDocumentWindowUI*/)
	{
		if(physicalViewId == Primary)
		{
			...
			rpguidCommandUI = &CLSID_VSPackage2EditorDocument;
